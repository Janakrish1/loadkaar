...
module.exports = {
    ...
    removeWarehouse: async (req, res) => {
        const { warehouse_id } = req.body; // Get the user ID from request params
        try {
            const removeQuery = `DELETE FROM Warehouse WHERE warehouse_id = ?`;
    ...
    updateWarehouse: async (req, res) => {
        ...
        try {
            const updateQuery = `UPDATE Warehouse SET warehouse_name = ?, availability_status = ?, available_sqft = ?, amenities = ? WHERE warehouse_id = ?`;
