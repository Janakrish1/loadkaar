...
const { registerUser, getUser, getUserID,getProfileDetails,updateProfileDetails, checkActiveUser, findDrivers, getUserDetailsforPayment } = require("./controllers/user");
